...
async def on_message(message):
    ...
    if message.content.startswith('Badass trigger'):
        await message.channel.send('https://images-ext-1.discordapp.net/external/PlFF4m9k4UtMs7Obbztrmc5YyOuq3rodXgNMMfC7hQ8/https/media.tenor.com/qfSDkr0lVSAAAAPo/merlo-uccelli.mp4')
    ...
    if 'play boss.mp3' in message.content:
        await message.channel.send('*Mephisto\'s speakers turn on* This is Sylus. Stay safe out there. And stop worrying about trivial matters, got it?')
